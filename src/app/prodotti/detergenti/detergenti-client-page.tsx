...
export default function DetergentiClientPage() {
  ...
  const productsQuery = useMemoFirebase(() => {
    ...
    let q: Query = query(collection(firestore, "prodotti"), where("categorie", "==", "Detergenti per Pulizia Professionale"));
  ...
  const heroImage = {
      imageUrl: "https://www.lintmicrofibercloths.it/wp-content/uploads/2025/07/Cat_Chimici.png",
      description: "Detergenti per pulizia professionale",
    ...
    <div>
      <section className="relative py-20 md:py-32 bg-secondary text-foreground text-center">
        ...
        <AnimateOnScroll className="container relative">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight">Detergenti per Pulizia Professionale</h1>
          <p className="mt-4 text-lg md:text-xl text-foreground/80 max-w-3xl mx-auto">
           Formule concentrate e ad alta efficacia per ogni tipo di sporco e superficie. I nostri detergenti professionali garantiscono pulizia profonda, igiene sicura e brillantezza duratura.
          </p>
        </AnimateOnScroll>
      </section>
        ...
        <AnimateOnScroll>
          ...
          {!isLoadingProducts && products?.length === 0 && (
            <div className="text-center col-span-full py-12 bg-secondary/50 rounded-lg">
              <p className="text-lg font-medium">Nessun detergente trovato</p>
