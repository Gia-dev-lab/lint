...
export default function KitPuliziaClientPage() {
  ...
  const productsQuery = useMemoFirebase(() => {
    ...
    let q: Query = query(collection(firestore, "prodotti"), where("categorie", "==", "Kit di Pulizia e Detailing Professionali"));
  ...
  const heroImage = {
      imageUrl: "https://www.lintmicrofibercloths.it/wp-content/uploads/2025/07/kit-1-moto-bike-scaled.jpg",
      description: "Kit pulizia professionale per moto e bici",
    ...
    <div>
      <section className="relative py-20 md:py-32 bg-secondary text-foreground text-center">
        ...
        <AnimateOnScroll className="container relative">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight">Kit di Pulizia e Detailing</h1>
          <p className="mt-4 text-lg md:text-xl text-foreground/80 max-w-3xl mx-auto">
           Soluzioni complete e pronte all'uso. I nostri kit sono studiati per offrire tutto il necessario per operazioni di pulizia e detailing specifiche, garantendo massima efficienza e risultati eccellenti.
          </p>
        </AnimateOnScroll>
      </section>
        ...
        <AnimateOnScroll>
          ...
          {!isLoadingProducts && products?.length === 0 && (
            <div className="text-center col-span-full py-12 bg-secondary/50 rounded-lg">
              <p className="text-lg font-medium">Nessun kit trovato</p>
