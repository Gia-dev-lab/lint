...
export default function LineaSelfCarWashClientPage() {
  ...
  const productsQuery = useMemoFirebase(() => {
    ...
    let q: Query = query(collection(firestore, "prodotti"), where("categorie", "==", "Linea Self Car Wash"));
  ...
  const heroImage = {
      imageUrl: "https://www.lintmicrofibercloths.it/wp-content/uploads/2024/10/CARTA-BIANCA-SELF.webp",
      description: "Prodotti per autolavaggio self service",
      imageHint: "car wash"
  }
    ...
    <div>
      <section className="relative py-20 md:py-32 bg-secondary text-foreground text-center">
        ...
        <AnimateOnScroll className="container relative">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight">Linea Self Car Wash</h1>
          <p className="mt-4 text-lg md:text-xl text-foreground/80 max-w-3xl mx-auto">
           Prodotti e consumabili di alta qualità per autolavaggi self-service. Soluzioni performanti per garantire ai tuoi clienti un risultato di pulizia eccellente e una gestione efficiente.
          </p>
        </AnimateOnScroll>
      </section>
